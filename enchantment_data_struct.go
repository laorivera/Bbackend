...
var Enchantments = Enchantment{
	...
	Helmet: map[string][]float32{
		...
		"BuffDurationBonus": {1, 2}, "DebuffDurationBonus": {0.7, 1.5}, "CooldownReduction": {0.7, 1.5},
		"MemoryCapacityAdd": {1, 2},
		"Luck":              {15, 30},
	},
	Chest: map[string][]float32{
		"Strength": {1, 3}, "Vigor": {1, 3}, "Agility": {1, 3}, "Dexterity": {1, 3}, "Will": {1, 3}, "Knowledge": {1, 3}, "Resourcefulness": {1, 3},
		"ArmorPenetration": {0.9, 1.8}, "PhysicalPowerBonus": {0.6, 1.2}, "MagicalPowerBonus": {0.7, 1.8}, "MagicPenetration": {0.7, 1.2},
		"ArmorRating": {5, 10}, "MagicResistance": {5, 10}, "PhysicalDamageReduction": {0.3, 0.6}, "MagicalDamageReduction": {0.5, 1}, "ProjectileReduction": {1, 1.5},
		"ActionSpeed": {0.9, 1.8}, "SpellCastingSpeed": {0.7, 1.5}, "RegularInteractionSpeed": {1, 2}, "MagicalInteractionSpeed": {1.5, 3},
		"BuffDurationBonus": {0.7, 1.5}, "DebuffDurationBonus": {1, 2}, "CooldownReduction": {1, 2},
		"MemoryCapacityAdd": {1, 4}, "MemoryCapacityBonus": {2, 5},
		"Luck": {22, 45},
	},
	Gloves: map[string][]float32{
		"Strength": {1, 2}, "Vigor": {1, 2}, "Agility": {1, 2}, "Dexterity": {1, 2}, "Will": {1, 2}, "Knowledge": {1, 2}, "Resourcefulness": {1, 2},
