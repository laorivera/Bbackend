...
var Enchantments = Enchantment{
	...
	Helmet: map[string][]float32{
		...
		"ArmorPenetration": {1, 1.2}, "PhysicalPowerBonus": {0.6, 1.2}, "PhysicalPower": {1, 2}, "MagicalPower": {1, 2}, "MagicalPowerBonus": {0.7, 1.2}, "TrueMagicalDamage": {1}, "AddiontalMagicalDamage": {1}, "MagicPenetration": {0.7, 1.2},
		...
		"MemoryCapacityAdd": {1, 2}, "MemoryCapacityBonus": {1.5, 3},
		"Luck": {15, 30},
	},
	Chest: map[string][]float32{
